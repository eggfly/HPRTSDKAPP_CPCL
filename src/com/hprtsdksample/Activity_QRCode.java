...
//		spnQRCodeLevel.setOnItemSelectedListener(new OnItemSelectedQRCodeLevel());
	...
	{				
		...
		{			
			switch (arg2) {
			case 0:
				qrcoderotation=HPRTPrinterHelper.BARCODE;
				break;
			case 1:
				qrcoderotation=HPRTPrinterHelper.VBARCODE;
				break;
	...
	//		HPRTPrinterHelper.printqrcode("123");
	    	HPRTPrinterHelper.PrintQR(qrcoderotation,txtqrcode_x.getText().toString(), txtqrcode_y.getText().toString(),QRCodeModel, QRCodeSize, txtQRCodeData.getText().toString());
